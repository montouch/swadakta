    ...
    if (status === "founder_review") {
      return {
        ...
        required_checks: uniqueStrings([
          ...
          "No manual-transfer fallback unless easier rails are unsuitable",
        ]),
        compliance_status: reviewComplianceStatus(request.compliance_status),
          ...
          categories: [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  label: "Payment rails",
                  status: "manual",
                  detail: "Stripe, PayPal, M-Pesa, and manual fallback rails require Vercel serverless functions and production env vars.",
