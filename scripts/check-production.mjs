...
const requiredPortalMarkers = [
  ...
  "renderAccountMoneyVerificationHub",
  "accountMoneyHubItems",
  "Manual fallback stays admin-only",
  "renderAccountHomeAutopilot",
  "renderAccountDataControl",
  "accountDataRequestTemplate",
  "copyAccountDataRequest",
  "automationReadinessScore",
  "AI can draft and triage",
  "provider evidence, accounting, disputes",
...
const requiredPortalHtmlMarkers = [
  ...
  "data-ai-mode-status",
  "account-data-control-panel",
  "account-money-verification-hub",
  "Payments &amp; verification hub",
  "copy-account-data-request",
...
const requiredPaymentsMarkers = [
  ...
  "Manual fallbacks stay admin-only",
  "Route payment fit checker",
  "The route decides which payment path is sensible",
  "route-payment-fit-form",
  "globalRoutePaymentFit",
  "Client quote disclosure builder",
  "quote-disclosure-form",
  "buildQuoteDisclosure",
  "Provider fee or surcharge boundary",
  "Service fee included",
  "Swadakta's service and operating fee is included",
  "Outside Africa to Africa",
  "Africa to overseas purchase or errand",
  "China sourcing or supplier buying",
  "High-value or sensitive funds",
...
const requiredPaymentIdempotencyMarkers = [
  ...
  ["api/payments/paypal-capture.js", "getPayPalOrderDetails"],
  ["api/payments/paypal-capture.js", "assertPayPalOrderMatchesRequestCode"],
  ["api/payments/paypal-capture.js", "assertPayPalOrderAmountMatchesStoredQuote"],
  ["api/payments/paypal-capture.js", "No Swadakta request matched the request code, so PayPal capture was not attempted"],
...
const requiredPaymentLaunchGateMarkers = [
  ...
  ["PAYMENTS_SETUP.md", "Provider Evidence Playbook"],
  ["PAYMENTS_SETUP.md", "server-side evidence matches the saved Swadakta request"],
  ["README.md", "Provider evidence playbook"],
...
const forbiddenUserFacingIncompleteMarkers = [
  ...
  ["login.html", "+254"],
  ["login.html", "Sage and Guide persona"],
  ["login.html", "premium professionals"],
  ["index.html", "Professional Marketplace"],
  ["portal.html", "Professional Marketplace"],
  ["portal.html", "Wise"],
  ["assistant.html", "Professional Marketplace"],
  ["payments.html", "Professional Marketplace"],
  ["payments.html", "Wise"],
  ["payments.html", "option value=\"wise\""],
  ["payments.html", "Bank / Wise"],
  ["trust.html", "Wise"],
...
const requiredAiServerMarkers = [
  ...
  ["api/ai/assistant.js", "AI request is too large"],
  ["api/ai/assistant.js", "wise_and_bank_transfer_require_verified_receipt_or_statement"],
  ["api/ai/assistant.js", "For Wise or bank-transfer payments"],
  ...
  ["supabase/functions/swadakta-assistant/index.ts", "AI request is too large"],
  ["supabase/functions/swadakta-assistant/index.ts", "wise_and_bank_transfer_require_verified_receipt_or_statement"],
  ["supabase/functions/swadakta-assistant/index.ts", "For Wise or bank-transfer payments"],
